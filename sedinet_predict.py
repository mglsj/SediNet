...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "python sedinet_predict.py -c configfile.json {-w weightsfile.weights.h5} OR {-1 weightsfile_batch1.weights.h5 -2 weightsfile_batch2.weights.h5 -3 weightsfile_batch3.weights.h5 -4 weightsfile_batch4.weights.h5}"
        )
        sys.exit(2)
    for opt, arg in opts:
        if opt == "-h":
            print(
                "Example usage (single batch / weights file): python sedinet_predict.py -c config/config_mattole.json -w mattole/res/mattole_simo_batch7_im512_512_2vars_pinball_aug.weights.h5"
            )
            print(
                "Example usage (multiple batches / weights files): python sedinet_predict.py -c config/config_9percentiles.json \
