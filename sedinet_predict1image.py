...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "python sedinet_predict1image.py -c configfile.json -i path/to/image.ext {-w weightsfile.hdf5} OR {-1 weightsfile_batch1.hdf5 -2 weightsfile_batch2.hdf5 -3 weightsfile_batch3.hdf5 -4 weightsfile_batch4.hdf5}"
        )
        sys.exit(2)
    for opt, arg in opts:
        if opt == "-h":
    ...
    if mode == "siso" or mode == "simo":
        if numclass > 0:
            result = estimate_categorical_1image(
                vars,
                image,
                res_folder,
                dropout,
            ...
            result = estimate_siso_simo_1image(
                vars,
                image,
                greyscale,
                dropout,
